...
function syncProtocol() {
    ...
    const files = {
        'Cervical_ACDF': 'Cervical_ACDF.pdf',
        'Cervical_Decompression_Fusion': 'Cervical_Decompression_Fusion.pdf',
        'Lumbar_Discectomy': 'Lumbar_Discectomy.pdf',
        'Lumbar_Decompression': 'Lumbar_Decompression.pdf',
        'Lumbar_Decompression_Fusion': 'Lumbar_Decompression.pdf' // Temporary duplicate as requested
    };
...
function loadSession(id) {
    ...
    // if (files[currentProc]) pdfView.src = '/data/...';
